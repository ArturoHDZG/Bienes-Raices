...
<main class="container section">
  ...
  <div class="home-icons"> <!-- Home Icons -->
    <div class="home-icon">
      ...
      <h3>Seguridad</h3>
      <p>Precios reales y finales, sin cobros sorpresas ni comisiones ocultas. Ten la seguridad de que
        nuestros bienes raíces y alquileres son tal cual en la publicación ¡Sin engaños!</p>
    </div>
    <div class="home-icon">
    ...
    <div class="home-icon">
      ...
      <h3>Rápido</h3>
      <p>¡Atención garantizada antes de 24hrs! Al momento de contactarte nuestro agente se pondrá en
        contacto contigo para resolver dudas o solicitar una cita.</p>
    </div>
  </div>
</main>
...
<div class="container section home-lowersection"> <!-- Blog, News & Testimonials -->
  ...
  <section class="home-testimonial"> <!-- Testimonials -->
    ...
    <div class="home-testimonial-text">
      <blockquote>El agente se comportó de forma excelente, muy buena atención y la casa que me
         ofrecieron era justamente lo que buscaba.</blockquote>
      <p>- Mary Sossa</p>
    </div>
  </section>
</div>
