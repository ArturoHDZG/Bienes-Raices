...
<main class="container section">
  ...
  <div class="about-content">
    ...
    <div class="about-text">
      ...
      <p>Piensas vender o alquilar tu propiedad, pero ya estas cansado de subir las fotos en redes sociales,
         ...
         de tu propiedad a potenciales compradores. ¡No hay problema!</p>
      <p>O tal vez estas buscando aquella casa de tus sueños, o necesitas alquilar un cómodo departamento donde tengas
         ...
         ¡Tampoco hay problema!</p>
      <p>¡En TICO CASAS somos la solución! Para que tu proceso de venta o de compra sea el más amigable, profesional,
         conciso y ágil para que tengas todos los elementos para tomar la mejor decisión, déjanos a nosotros el trabajo,
         tu solo preocúpate de lo realmente importante.</p>
    </div>
  </div>
</main>
