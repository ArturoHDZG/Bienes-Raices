    ...
    <main class="container section content-center">
      ...
      <form class="form">
        ...
        <fieldset>
          ...
          <input id="name" type="text" placeholder="ej. Juan Rodríguez" required>

          <label for="email">e-Mail:</label>
          <input id="email" type="email" placeholder="ej. correo@dominio.com" required>

          <label for="phone">Teléfono:</label>
          <input id="phone" type="tel" placeholder="ej. 5555-5555" required>

          <label for="message">Mensaje:</label>
          <textarea placeholder="Escribe tu mensaje" id="message" required></textarea>
